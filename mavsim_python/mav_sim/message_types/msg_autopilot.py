...
class MsgAutopilot:
    ...
    def __str__(self) -> str:
        ...
        out =   "airspeed_command: " + str(self.airspeed_command) + \
                ", course_command: " + str(self.course_command) + \
                ", altitude_command: " + str(self.altitude_command) + \
                ", phi_feedforward: " + str(self.phi_feedforward)
        return out
